...
public:
	...
	make_client(as::io_context& ios, std::string host, std::string port);
	...
	make_client_no_strand(as::io_context& ios, std::string host, std::string port);
	...
	make_client_ws(as::io_context& ios, std::string host, std::string port, std::string path);
	...
	make_client_no_strand_ws(as::io_context& ios, std::string host, std::string port, std::string path);
#endif // defined(MQTT_USE_WS)
	...
	make_tls_client(as::io_context& ios, std::string host, std::string port);
	...
	make_tls_client_no_strand(as::io_context& ios, std::string host, std::string port);
	...
	make_tls_client_ws(as::io_context& ios, std::string host, std::string port, std::string path);
	...
	make_tls_client_no_strand_ws(as::io_context& ios, std::string host, std::string port, std::string path);
#endif // defined(MQTT_USE_WS)
...
private:
	...
	void connect_impl(Socket& socket, Iterator it, Iterator end, async_handler_t const& func = async_handler_t()) {
		...
		as::async_connect(
			...
			(boost::system::error_code const& ec, as::ip::tcp::resolver::results_type::iterator) mutable {
...
make_client(as::io_context& ios, std::string host, std::string port) {
	struct impl : client<tcp_endpoint<as::ip::tcp::socket, as::io_context::strand>> {
		impl(as::io_context& ios,
			 std::string host,
			 std::string port,
			 bool tls)
		: client<tcp_endpoint<as::ip::tcp::socket, as::io_context::strand>>(ios, std::move(host), std::move(port), tls) {}
	};
	return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), false);
}

inline std::shared_ptr<client<tcp_endpoint<as::ip::tcp::socket, as::io_context::strand>>>
make_client(as::io_context& ios, std::string host, std::uint16_t port) {
...
inline std::shared_ptr<client<tcp_endpoint<as::ip::tcp::socket, null_strand>>>
make_client_no_strand(as::io_context& ios, std::string host, std::uint16_t port) {
...
make_client_ws(as::io_context& ios, std::string host, std::string port, std::string path = "/") {
	struct impl : client<ws_endpoint<as::ip::tcp::socket, as::io_context::strand>> {
		impl(as::io_context& ios,
			 std::string host,
			 std::string port,
			 bool tls,
			 std::string path)
			:
			client<ws_endpoint<as::ip::tcp::socket, as::io_context::strand>>
...
inline std::shared_ptr<client<ws_endpoint<as::ip::tcp::socket, as::io_context::strand>>>
make_client_ws(as::io_context& ios, std::string host, std::uint16_t port, std::string path = "/") {
...
inline std::shared_ptr<client<ws_endpoint<as::ip::tcp::socket, null_strand>>>
make_client_no_strand_ws(as::io_context& ios, std::string host, std::uint16_t port, std::string path = "/") {
...
make_tls_client(as::io_context& ios, std::string host, std::string port) {
	struct impl : client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_context::strand>> {
		impl(as::io_context& ios,
			 std::string host,
			 std::string port,
			 bool tls)
		: client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_context::strand>>(ios, std::move(host), std::move(port), tls) {}
	};
...
inline std::shared_ptr<client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_context::strand>>>
make_tls_client(as::io_context& ios, std::string host, std::uint16_t port) {
...
inline std::shared_ptr<client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>>>
make_tls_client_no_strand(as::io_context& ios, std::string host, std::uint16_t port) {
...
make_tls_client_ws(as::io_context& ios, std::string host, std::string port, std::string path = "/") {
	struct impl : client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_context::strand>> {
		impl(as::io_context& ios,
			 std::string host,
			 std::string port,
			 bool tls,
			 std::string path)
			:
			client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_context::strand>>
			(ios, std::move(host), std::move(port), tls, std::move(path)) {}
	};
...
inline std::shared_ptr<client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_context::strand>>>
make_tls_client_ws(as::io_context& ios, std::string host, std::uint16_t port, std::string path = "/") {
...
inline std::shared_ptr<client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>>>
make_tls_client_no_strand_ws(as::io_context& ios, std::string host, std::uint16_t port, std::string path = "/") {
